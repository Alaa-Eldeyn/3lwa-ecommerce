...
const HeroCards = () => {
  ...
  return (
    ...
    <div className="-translate-y-16 lg:-translate-y-40 container z-20 grid grid-cols-3 gap-4 px-4 md:px-6 py-6 lg:pb-0">
      {cards.map((card) => (
        <div
          key={card.id}
        ...
        >
          <div className="p-0 lg:p-5 flex-1 flex flex-col">
            ...
            {/* Card Type 3 & 4: Single Large Image */}
              ...
              <div className="relative w-full aspect-4/3 lg:mb-4 rounded-lg overflow-hidden flex-1">
                <Image
                  src={card.image}
                  alt={card.title}
                  fill
