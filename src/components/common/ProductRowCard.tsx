          ...
          <div className="flex items-center gap-2 ms-auto">
            {cartItem ? (
              ...
              <button
                ...
                className="bg-primary hover:bg-secondary text-white dark:bg-white dark:text-primary dark:hover:bg-gray-200 rounded-lg px-4 py-2 center soft font-medium text-xs md:text-sm shadow-sm hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed transition-all whitespace-nowrap"
                title="Add to cart">
